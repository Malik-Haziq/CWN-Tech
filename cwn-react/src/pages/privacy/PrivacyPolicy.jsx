  ...
  return (
    <main>
      ...
      <div className="section mx-auto p-8 mt-12">
        ...
        <h3 className="text-xl font-semibold mt-4 mb-2 text-sub-heading">
          Interpretation
        </h3>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside flex flex-col gap-3">
          ...
          <li>
            ...
            this Agreement) refers to Code With Naqvi , Lahore, Pakistan.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to codewithnaqvi, accessible from
            <a
              href="https://www.codewithnaqvi.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.codewithnaqvi.com/
            </a>
          </li>
          <li>
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2 text-sub-heading">
          Personal Data
        </h4>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside text-sub-para flex flex-col gap-3 mb-8">
          <li>Email address</li>
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2 text-para">
        ...
        <ul className="list-disc list-inside flex flex-col gap-5 text-para">
          <li>
            <span>
        ...
        <ul className="list-disc list-inside flex flex-col gap-3 text-para">
          <li>
            <span>By email: codewithnaqvi@gmail.com</span>
          </li>
          <li>
            <span>
              By visiting this page on our website:
              <a
                href="https://www.codewithnaqvi.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.codewithnaqvi.com/contact
              </a>
            </span>
          </li>
          <li>
